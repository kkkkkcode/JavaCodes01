...
public class LotteryTest {
    public static void main(String[] args) {
        ...
        //有一点需要注意：如果中了同一个号码，则不能算中了多次，只能算中了一次
        ...
        printArray(judgeRed);
//        System.out.println(dupTimes);
//        System.out.println(timesInArray(redBall, 7));
